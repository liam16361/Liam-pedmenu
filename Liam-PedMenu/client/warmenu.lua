...
local defaultStyle = {
    ...
    bannerImage = 'https://cdn.discordapp.com/attachments/1057339665981648936/1064324434862817280/yes.png' -- Change URL here to change banner background.
}


local runtime = CreateRuntimeTxd('liam-pedmenu')
local image = CreateDui(defaultStyle.bannerImage, 400, 90)
...
function WarMenu.CreateMenu(id, title, subTitle, style)
	...
	menus[id] = menu
    WarMenu.SetTitleBackgroundSprite(id, 'liam-pedmenu', 'banner')
end
